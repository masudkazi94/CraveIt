    ...
    return (
        <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
            <div className='flex items-center'>
                ...
                <h1 className='text-3xl sm:text-3xl lg:text-3xl px-2 font-bold'>Crave
                    <span className='text-orange-700 font-bold'>It</span>
                </h1>
            ...
            <div className={sideNav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300'
                ...
                <h2 className='text-2xl p-4'>Crave <span className='text-orange-700 font-bold'>It</span></h2>
                <nav>
