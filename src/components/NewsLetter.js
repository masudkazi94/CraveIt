...
const NewsLetter = () => {
  return (
    <div className='max-w-[1520px] m-auto text-white py-4 px-6 bg-[#24262b]'>
        <div className='mx-auto grid lg:grid-cols-3'>
            <div className='lg:col-span-2 my-4'>
                <h1>Need advice on how to improve your flow ?</h1>
                <p>Sign up to join our newsletter and stay up top date.</p>
            </div>
            <div className='my-4'>
                ...
                <span className='text-[300df9a] '>Privacy Policy</span>
                </p>
            </div>
